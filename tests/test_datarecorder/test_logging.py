...
class TestMainLoggingCalls:
    ...
    def test_initialize_gpio_interrupt(self):
    ...
    def test_initialize_rfm69(self):
    ...
    def test_initialize_processing_thread(self):
...
class TestDataProcessing:
    ...
    def test_unpack_data_packet(self):
    ...
    def test_process_radio_data(self):
    ...
    def test_init_data_processing_thread(self):
...
class TestOledDisplay:
    ...
    def test_setup_hardware_oled(self):
    ...
    def test_write_text_to_display(self):
        mock_image_draw = mocker.patch.object(PIL, "ImageDraw", autospec=True)
    ...
    def test_display_message_from_queue(self):
    ...
    def test_init_display_thread(self):

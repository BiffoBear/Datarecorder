...
class TestIntegrationWithDataProcessing:
    ...
    def test_message_from_init_radio(self, mocker):
        mock_write_message_to_queue = mocker.patch.object(datarecorder._oleddisplay, "write_message_to_queue")
    ...
    def test_message_sent_when_bad_packet_received(self, mocker):
        mock_write_message_to_queue = mocker.patch.object(datarecorder._oleddisplay, "write_message_to_queue")
        mock_unpack_data_packet = mocker.patch.object(datarecorder._dataprocessing, "unpack_data_packet")
